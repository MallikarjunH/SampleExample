...
class ViewController: UIViewController {
    ...
    @objc func pan(_ gesture: UIPanGestureRecognizer) {
        ...
        case .changed:
            ...
            if signatoryViewArray.count > 0 {
                ...
                //  pdfFrame = view.convert(signatoryViewArray[index].frame, from: pdfView)
                //  print("touchesMoved \(pdfFrame!.dictionaryRepresentation)")
    ...
    func loadPdf(){
        ...
        if let path = Bundle.main.path(forResource: "appointment-letter", ofType: "pdf") {
            if let pdfDocument = PDFDocument(url: URL(fileURLWithPath: path)) {
                ...
                totolPagesOfPdf = pdfDocument.pageCount
    ...
    @IBAction func sendButtonClickAction(_ sender: Any) {
        ...
        frame = view.convert(customeView.frame, from: pdfView)
